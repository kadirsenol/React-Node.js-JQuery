const About = ()=>{
  ...
  <div className="w3-white">
    <div className="w3-dark-grey" style={{ height: 28, width: "95%" }} />
  </div>
  <p className="w3-wide">Web Design</p>
  <div className="w3-white">
    <div className="w3-dark-grey" style={{ height: 28, width: "85%" }} />
  </div>
  <p className="w3-wide">Photoshop</p>
  <div className="w3-white">
    <div className="w3-dark-grey" style={{ height: 28, width: "80%" }} />
  </div>
  <br />
  ...
  />
  <p>
    <span className="w3-large w3-margin-right">Chris Fox.</span> CEO at Mighty
    Schools.
  </p>
